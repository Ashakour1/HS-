...
export const departments: Record<string, any> = {
  "internal-medicine": {
    ...
    icon: Stethoscope, // Changed from Sun
  },
  "general-surgery": {
    id: 2,
    ...
    icon: Scissors, // Changed from ClipboardList
  },
  pediatrics: {
    id: 3,
    name: "Pediatrics",
    ...
    icon: Baby, // Changed from UserCog
  },
  cardiology: {
    id: 4,
    name: "Cardiology",
    ...
    icon: HeartPulse, // Changed from Baby
  },
  oncology: {
    id: 5,
    name: "Oncology",
    ...
    icon: LampDesk, // Changed from ShipWheel (Wheelchair)
  },
  maternity: {
    id: 6,
    ...
    icon: Baby, // Changed from Footprints (Walk)
  },
  "inpatient-department": {
    id: 7,
    name: "Inpatient Department (IPD)",
    image: "/All-2.jpg",
    href: "/inpatient-department",
    description:
    ...
    icon: Bed, // Changed from PlusSquare
  },
  ot: {
    id: 8,
    ...
    icon: Scissors, // Changed from Infinity
  },
  pharmacy: {
    id: 9,
  ...
  obg: {
    ...
    icon: UserCog, // Changed from Infinity
  },
};
